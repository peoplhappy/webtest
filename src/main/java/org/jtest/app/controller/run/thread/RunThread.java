package org.jtest.app.controller.run.thread;
...
public class RunThread implements Runnable {
	...
	private ThreadLocal<ThreadLocalParam> param=new ThreadLocal<ThreadLocalParam>();
	...
	public RunThread(RunType type,String userId, Object testObject,ConfigService configservice,TestCaseService testcaseservice,
			ProtocalService service,InfsService infsservice,TestCaseResultService resultservice,InfsResultService infresservice,LogTreeItemService logtreeitemservice,
			WebSocketController websocketservice,TestSuiteService testsuiteservice) {
		this.type = type;
		...
		this.infsservice=infsservice;
		this.resultservice=resultservice;
		this.infresservice=infresservice;
		this.logtreeitemservice=logtreeitemservice;
