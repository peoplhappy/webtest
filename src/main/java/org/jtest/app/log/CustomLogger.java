...
public class CustomLogger {
	...
	public void logInfo(String data) {
		...
		// System.out.println("info:"+name+"_"+MDC.get("logFileName")+"
		// content:"+data+" threadname:"+Thread.currentThread().getName());
		logger.info(data);
	...
	public void logError(String data) {
		// System.out.println("error:"+name+"_"+MDC.get("logFileName")+"
		// content:"+data+" threadname:"+Thread.currentThread().getName());
		logger.error(data);
